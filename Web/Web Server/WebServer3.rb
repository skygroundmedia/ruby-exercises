#
# Serve an HTML from the HardDisk but also be able to read Embedded Ruby
...
class RequestHandler
  ...
  def process
    ...
    # Create an Embedded Ruby routine (block). There must be a string interpretation
    template = ERB.new <<-EOF
      #{tmpFile}
    EOF
    # With Embedded Ruby, you have to bind it's results at Execution
